...
# def print_need_table(processes, need_matrix, resources):
#     header = ["Resource {}".format(i + 1) for i in range(len(resources))]
#     print("\n{:10} {}".format("Process", " ".join(header)))
#     for i in range(processes):
#         print("{:10} {}".format(
#             f"P{i}",
#             " ".join(map(str, need_matrix[i]))
#         ))

# # Update the call to print_need_table in bankers_algorithm
# print_need_table(processes, need_matrix, initial_resources)
